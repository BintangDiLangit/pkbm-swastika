                        ...
                        <div class="aboutarea__content__tap__wraper">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="single__event__wraper single__award" data-aos="fade-up">
                                        <div class="eventarea__img">
                                            <img loading="lazy" src="{{ asset('assets/img/about/award-1.jpg') }}"
                                                alt="event">
                                        </div>
                                        <div class="eventarea__content__wraper">
                                            ...
                                            <div class="single__event__button">
                                                <a href="event-details.html">Read More <i
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="single__event__wraper single__award" data-aos="fade-up">
                                        <div class="eventarea__img">
                                            <img loading="lazy" src="{{ asset('assets/img/about/award-2.jpg') }}"
                                                alt="event">
                                        </div>
                                        <div class="eventarea__content__wraper">
                                            <div class="single__event__heading">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="single__event__wraper single__award" data-aos="fade-up">
                                        <div class="eventarea__img">
                                            <img loading="lazy" src="{{ asset('assets/img/about/award-3.jpg') }}"
                                                alt="event">
                                        </div>
                                        <div class="eventarea__content__wraper">
                                            <div class="single__event__heading">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                    <div class="single__event__wraper single__award" data-aos="fade-up">
                                        <div class="eventarea__img">
                                            <img loading="lazy" src="{{ asset('assets/img/about/award-4.jpg') }}"
                                                alt="event">
                                        </div>
                                        <div class="eventarea__content__wraper">
                                            <div class="single__event__heading">
