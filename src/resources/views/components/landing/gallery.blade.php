            ...
            <div class="photo__gallery__img">
                ...
                <div class="single__gallery__img">
                    ...
                    <div class="gallery__icon">
                        <a class="popup__img" href="{{ asset('assets/img/blog/blog_15.png') }}"> <i
                ...
                <div class="single__gallery__img">
                    ...
                    <div class="gallery__icon">
                        <a class="popup__img" href="{{ asset('assets/img/blog/blog_16.png') }}"> <i
                                class="icofont-eye-alt"></i></a>
                    </div>
                </div>
                <div class="single__gallery__img">
                    ...
                    <div class="gallery__icon">
                        <a class="popup__img" href="{{ asset('assets/img/blog/blog_17.png') }}"> <i
                                class="icofont-eye-alt"></i></a>
                    </div>
                </div>
                <div class="single__gallery__img">
                    ...
                    <div class="gallery__icon">
                        <a class="popup__img" href="{{ asset('assets/img/blog/blog_18.png') }}"> <i
                                class="icofont-eye-alt"></i></a>
                    </div>
                </div>
                <div class="single__gallery__img">
                    ...
                    <div class="gallery__icon">
                        <a class="popup__img" href="{{ asset('assets/img/blog/blog_19.png') }}"> <i
                                class="icofont-eye-alt"></i></a>
                    </div>
                </div>
                <div class="single__gallery__img">
                    ...
                    <div class="gallery__icon">
                        <a class="popup__img" href="{{ asset('assets/img/blog/blog_20.png') }}"> <i
                                class="icofont-eye-alt"></i></a>
                    </div>
                </div>
                ...
                <div class="single__gallery__img">
                    ...
                    <div class="gallery__icon">
                        <a class="popup__img" href="{{ asset('assets/img/blog/blog_29.jpg') }}"> <i
                                class="icofont-eye-alt"></i></a>
                    </div>
                </div>
                <div class="single__gallery__img">
                    ...
                    <div class="gallery__icon">
                        <a class="popup__img" href="{{ asset('assets/img/blog/blog_30.jpg') }}"> <i
                                class="icofont-eye-alt"></i></a>
                    </div>
                </div>
