        ...
        <div class="row" data-aos="fade-up">
            <div class="col-xl-12">
                <ul class="nav  tab__button__wrap" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="single__tab__link" data-bs-toggle="tab" data-bs-target="#projects__five"
                ...
                <div class="social__wrapper">
                    <div class="single__event__wraper" data-aos="fade-up">
                        <div class="eventarea__img">
                            <img loading="lazy" src="img/event/event__1.png" alt="event">
                        </div>
                        <div class="eventarea__content__wraper">
                            ...
                            <div class="single__event__heading">
                                <h4><a href="event-details.html">Forging relationships between multi to
                                        national governments and global.</a></h4>
                            </div>
                    ...
                    <div class="single__event__wraper single__event__wraper__2" data-aos="fade-up">
                        ...
                        <div class="eventarea__img">
                            <img loading="lazy" src="img/event/event__2.png" alt="event">
                        </div>
                    </div>
                    ...
                    <div class="single__event__wraper" data-aos="fade-up">
                        <div class="eventarea__img">
                            <img loading="lazy" src="img/event/event__3.png" alt="event">
                        </div>
                        <div class="eventarea__content__wraper">
                            <div class="eventarea__list">
                                <ul>
                    ...
                    <div class="single__event__wraper single__event__wraper__2" data-aos="fade-up">
                        ...
                        <div class="eventarea__img">
                            <img loading="lazy" src="img/event/event__4.png" alt="event">
                        </div>
                    </div>
